...
namespace Airport_Airplane_management_system.View.Forms.UserPages
{
    public partial class UserDashboard : UserControl, IUserDashboardView
    {
        ...
        private Airport_Airplane_management_system.Model.Interfaces.Services.INotificationsCounterService _notifCounterService;
        private Airport_Airplane_management_system.Model.Interfaces.Repositories.INotificationsCounterRepository _notifCounterRepo;
        ...
        public UserDashboard(INavigationService navigation)
        {
            ...
            _flightService = new FlightService(flightRepo, userRepo, bookingRepo, planeRepo, notifRepo);
        ...
        private void CreateNotificationsBadge()
        {
            ...
            btnNotifications.LocationChanged += (_, __) => PositionNotificationsBadge();
            btnNotifications.SizeChanged += (_, __) => PositionNotificationsBadge();
            guna2Panel1.SizeChanged += (_, __) => PositionNotificationsBadge();
