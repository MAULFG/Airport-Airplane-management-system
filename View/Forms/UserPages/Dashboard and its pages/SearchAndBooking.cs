...
namespace Airport_Airplane_management_system.View.Forms.UserPages
{
    public partial class SearchAndBooking : UserControl, ISearchAndBookingView
    {
        public SearchAndBooking()
        {
            ...
            cbClass.GotFocus += (s, e) =>
            {
                if (cbClass.Text == "Select Class")
                {
                    cbClass.Text = "";
        ...
        public string From => cbFrom.Text == "Select From" ? null : cbFrom.Text;
        public string To => cbTo.Text == "Select To" ? null : cbTo.Text;
